...
func ErrInsufficientFunds(err error) *AppError {
	return NewErrorResponse(err, "insufficient funds", err.Error(), "ErrInsufficientFunds")
}
...
func ErrCannotCountEntity(entity string, err error) *AppError {
	return NewCustomError(
		err,
		fmt.Sprintf("Cannot count %s", strings.ToLower(entity)),
		fmt.Sprintf("ErrCannotCount%s", entity),
	)
}
...
func ErrInvalidAddress() *AppError {
	return NewCustomError(
		nil,
		fmt.Sprintf("Invalid address"),
		fmt.Sprintf("ErrInvalidAddress"),
	)
}
...
func ErrInvalidSignature() *AppError {
	return NewCustomError(
		...
		fmt.Sprintf("ErrInvalidSignature"),
	)
}
